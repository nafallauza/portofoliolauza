                ...
                <div className="contact-form-container">
                    <div className="contact-form-header">
                        ...
                        <div className="contact-socials">
                            <a href="https://www.linkedin.com/in/nafal-lauza-83a579275/?locale=in" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                                </svg>
                            </a>
                            <a href="https://www.tiktok.com/@lauzaaaaa_?_r=1&_t=ZS-97ugMMHTa2W" target="_blank" rel="noreferrer" aria-label="TikTok">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 2.23-1.15 4.34-2.88 5.73-1.84 1.48-4.29 2-6.57 1.51-2.31-.49-4.32-2.02-5.46-4.08-1.15-2.06-1.28-4.63-.34-6.81 1.05-2.4 3.39-4.14 5.96-4.6.01 1.41 0 2.83.02 4.24-1.17.18-2.29.83-2.94 1.83-.69 1.05-.75 2.41-.16 3.51.52.98 1.45 1.68 2.53 1.9.96.2 1.98.05 2.82-.44.75-.44 1.29-1.16 1.51-2.02.19-.74.14-1.53.14-2.29.01-6.73-.01-13.46.03-20.19-.01 0-.01 0-.01 0z"/>
                                </svg>
                            </a>
                            <a href="https://www.instagram.com/lauzaaaaa_?igsh=MWpxaW4wdHJnd3B3Zg==" target="_blank" rel="noreferrer" aria-label="Instagram">
                                <svg viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="https://wa.me/qr/522OQ7OQIFPJB1" target="_blank" rel="noreferrer" aria-label="WhatsApp">
                                <svg viewBox="0 0 24 24" fill="currentColor">
